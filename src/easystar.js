...
exports.js = js = function js() {
    ...
    **/
    this.findPath = function (startX, startY, endX, endY, callback) {
        ...
        // Create the instance
        var instance = new _instance.instance();
    ...
    **/
    ...
    var calculateDirection = function calculateDirection(diffX, diffY) {
        if (diffX === 0 && diffY === -1) return TOP;else if (diffX === 1 && diffY === -1) return TOP_RIGHT;else if (diffX === 1 && diffY === 0) return RIGHT;else if (diffX === 1 && diffY === 1) return BOTTOM_RIGHT;else if (diffX === 0 && diffY === 1) return BOTTOM;else if (diffX === -1 && diffY === 1) return BOTTOM_LEFT;else if (diffX === -1 && diffY === 0) return LEFT;else if (diffX === -1 && diffY === -1) return TOP_LEFT;
    ...
    var coordinateToNode = function coordinateToNode(instance, x, y, parent, cost) {
        ...
        var node = new _node.node(parent, x, y, costSoFar, simpleDistanceToTarget);
...
exports.TOP = TOP = 'TOP';
exports.TOP_RIGHT = TOP_RIGHT = 'TOP_RIGHT';
exports.RIGHT = RIGHT = 'RIGHT';
exports.BOTTOM_RIGHT = BOTTOM_RIGHT = 'BOTTOM_RIGHT';
exports.BOTTOM = BOTTOM = 'BOTTOM';
exports.BOTTOM_LEFT = BOTTOM_LEFT = 'BOTTOM_LEFT';
exports.LEFT = LEFT = 'LEFT';
exports.TOP_LEFT = TOP_LEFT = 'TOP_LEFT';
exports.js = js;
exports.TOP = TOP;
